@if ($produtosFavoritos->collection->count() > 0)
    <div class="section-products first-vitrine">
        <div class=" container">
                            ...
                            @itemAvailable($itemFavorito)
                                <div class="swiper-slide">
                                    ...
                                    src="{{ thumb($itemFavorito->main_image->source) }}" @endif
                                                ...
                                                @include(@engine_view('component_flag'))
                                            </figure>
                                        </a>
...
"
                                            ...
                                            @if (
                                                $itemFavorito->extraFields->get('selecionar_flag') &&
                                                    $itemFavorito->extraFields->get('selecionar_flag')->values->isNotEmpty())
                                                {{ $itemFavorito->extraFields->get('selecionar_flag')->values->first()->value }}
                                            @endif
